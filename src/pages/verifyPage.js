...
function VerifyPage() {
  return (
    <div>
      ...
      <p className="mx-[12vw] lg:mx-2 mt-6 font-r text-justify text-gray-700">
      ...
      <h1 className="text-2xl mx-[12vw] lg:mx-2 mt-6 text-center text-purple-600 border-2">
        Riya Singh
        <span className="relative inline-flex items-center ml-1 top-1">
          <Verification />
        </span>
      </h1>
      <h2 className="mx-[12vw] lg:mx-2 mt-12  font-r text-xl text-gray-700">
