  ...
  return (
    <div>
      ...
      <Link
        ...
        className="text-purple-600 mx-[12vw]"
      >
        vibes.incampus
      </Link>
      <h2 className="mx-[12vw] mt-6  font-r text-xl text-gray-700">Email</h2>
      <a href="mailto:vibes.incampus@gmail.com" className="text-purple-600 mx-[12vw]">
